...
function endGame() {
	...
	const playersInfos = document.getElementById("playersInfos");
	const gameOverMessage = document.getElementById("gameOverMessage");
	const winner = document.querySelector('.fightFont:nth-child(1)').textContent;

	gameStarted = false;
	canvas.style.display = "none";
	pauseGameInfos.style.display = "none";
	commandGameInfos.style.display = "none";
	playersInfos.style.display = "none";
	if (scorePlayerOne > scorePlayerTwo)
		gameOverMessage.textContent = "Partie terminée, vainqueur : " + winner;
	else
		gameOverMessage.textContent = "Partie terminée, vainqueur : IA";
