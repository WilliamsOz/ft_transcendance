...
describe('FriendService', () => {
  ...
  describe('createFriendship', () => {
    it('should create a new friendship', async () => {
      ...
      jest
        .spyOn(prismaClient.friends, 'create')
        .mockResolvedValue(mockFriendship);

      expect(await friendService.createFriendship(friendData)).toEqual(
        mockFriendship,
      );
    });
  });
  describe('deleteFriendship', () => {
    it('should delete a friendship', async () => {
      ...
      jest
        .spyOn(prismaClient.friends, 'findUnique')
        .mockResolvedValue(mockFriendship);
      jest
        .spyOn(prismaClient.friends, 'delete')
        .mockResolvedValue(mockFriendship);
