...
from User.views import log, home, create_user, oauth_token, profil, redirect_to_home , RGPD_Politique , consent , delete_user , anonymize_user, verify_code, verify_totp, enable_totp
